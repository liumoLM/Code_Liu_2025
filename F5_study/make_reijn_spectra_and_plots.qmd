...
mvcf = read.delim(mouse, sep = '\t') # Mice

rvcf = read.delim(rpe1, sep = '\t') # Cells
```
...
stdwrite(cell_mut, "Manuscript_data/Reijn_mut_cell_annot.vcf")

rvcf %>% dplyr::filter(!Sample %in% c("AKO1_4", "BKO1_4")) -> cell_wt
stdwrite(cell_wt, "Manuscript_data/Reijn_wt_cell_annot.vcf")
```
...
stdwrite(mouse476, "F5_study/mutated_mice.tsv")
...
plot_cells476 = function() {
  ...
  r4_mut = r4[, 1:2]
  stdwrite("F5_study/mutated_cells.tsv")
  r4_wt = r4[, 3:5]
  stdrwrte("F5_study/wild_type_cells.tsv")
