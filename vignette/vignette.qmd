...
Source file:  `r xfun::with_ext(knitr::current_input(), "qmd")`
...
REGENERATE_CONNECTION_TABLE <- FALSE
...
[
\* Asterisks on entries in the "Closest \{Koh,Jin\} et al. Sig" columns indicate that the marked signature has the best match, while other signatures in the column also have matches above 0.9
...
if (cache_valid) {
  ...
  all_plot_paths <- generate_all_plots_parallel(
    ...
    n_workers = if (isTRUE(getp("force_single_worker"))) 1 else 10
  )
