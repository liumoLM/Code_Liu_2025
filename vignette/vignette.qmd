---
title: "Insertion and deletion mutational signatures"
date: today
format:
  html:
    toc: true
...
ppar <- list(w476 = 19, h476 = 6, w89 = 24, h89 = 6, basesize89 = 17)
...
# Generate all plots in parallel (10 workers)
# This is the main performance optimization - plotting is done once upfront
# Use local directory so plots persist for pandoc
...
message("All plots generated in: ", plot_dir)
```
